 ...
 * @author nnawa_000
 */
public class DonationDetailsList extends javax.swing.JFrame {

    /**
     * Creates new form donarList
     */
    public DonationDetailsList() {
        initComponents();
        try {  
    ...
    UpdateDonationDetails jtRowData = new UpdateDonationDetails();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("DONATION DETAILS");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(194, 41, 261, 29);
        ...
        jScrollPane1.setBounds(36, 113, 822, 427);
        ...
        btn_BACK.setBounds(15, 45, 67, 27);
        ...
        btn_update.setBounds(512, 40, 125, 31);
        ...
        btn_delete.setBounds(749, 40, 124, 31);
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        ...
        String DonationNumber = model.getValueAt(index, 0).toString();
        String BagNumber = model.getValueAt(index, 1).toString();
        String Hospital = model.getValueAt(index, 2).toString();
        String CollectionDate = model.getValueAt(index, 3).toString();
        String GivingDate = model.getValueAt(index, 4).toString();
        String GivenAmount = model.getValueAt(index, 5).toString();
        ...
        jtRowData.txt_Hospital.setText(Hospital);
        jtRowData.txt_CollectionDate.setText(CollectionDate); 
        jtRowData.txt_GivingDate.setText(GivingDate);
        jtRowData.txt_GivenAmount.setText(GivenAmount);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonationDetailsList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DonationDetailsList().setVisible(true);
            }
        });
    }
